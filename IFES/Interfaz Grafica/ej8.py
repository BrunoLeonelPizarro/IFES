...
etiqueta1.grid(row= 0,column=0, sticky= "w", pady=20,padx=20)
texto1=Entry(marco)
texto1.grid(row=0, column= 1)

etiqueta2 = Label(marco, text="Ingrese el 2° valor")
etiqueta2.grid(row= 1,column=0, sticky= "w", pady=20,padx=20)
texto2=Entry(marco)
texto2.grid(row=1, column= 1)

etiqueta3 = Label(marco, text="Ingrese el 3° valor")
etiqueta3.grid(row= 2,column=0,sticky= "w", pady=20,padx=20)
texto3=Entry(marco)
