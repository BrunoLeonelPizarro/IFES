...
etiqueta1.config(fg= "blue", bg = "white", width = 35, font = ("Arial",12), anchor="w")
...
etiqueta2.config(fg= "blue", bg = "white", width = 35, font = ("Arial",12), anchor="w")
...
etiqueta3.config(fg= "blue", bg = "white", width = 35, font = ("Arial",12), anchor="w")
